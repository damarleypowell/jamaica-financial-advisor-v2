...
createRoot(document.getElementById('root')!).render(
  <StrictMode>
    <ErrorBoundary fallback={
      <div style={{ minHeight: '100vh', background: 'var(--color-bg2)', display: 'flex', alignItems: 'center', justifyContent: 'center' }}>
        <div style={{ textAlign: 'center', padding: 32 }}>
          <p style={{ fontSize: 24, fontWeight: 700, color: 'rgba(var(--fg),1)', marginBottom: 8 }}>Gotham</p>
