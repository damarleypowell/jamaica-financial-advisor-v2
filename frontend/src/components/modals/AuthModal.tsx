...
const S: Record<string, CSSProperties> = {
  ...
  btnDark: { width: '100%', height: 44, borderRadius: 10, background: FDARK, color: '#04060d', fontWeight: 700, fontSize: 15, border: 'none', cursor: 'pointer', fontFamily: BODY, letterSpacing: '.01em', transition: 'transform .15s cubic-bezier(.34,1.56,.64,1), box-shadow .15s, opacity .15s' },
