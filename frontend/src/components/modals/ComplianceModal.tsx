  ...
  const items = [
    {
      ...
      label: 'I understand Gotham is an educational and research tool, not a regulated investment advisor.',
    },
    {
          ...
          <div style={{
            ...
            <div style={{ display: 'flex', alignItems: 'flex-start', gap: 10 }}>
              ...
              <p style={{ margin: 0, fontSize: 13, color: 'var(--color-text2)', lineHeight: 1.6 }}>
                Gotham provides market data, AI-powered analysis, and financial education.
