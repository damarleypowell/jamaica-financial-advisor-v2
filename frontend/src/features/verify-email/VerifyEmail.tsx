      ...
      <div style={{ background: '#fff', borderRadius: 20, padding: '48px 40px', maxWidth: 440, width: '100%', textAlign: 'center', boxShadow: '0 8px 40px rgba(0,0,0,.08)' }}>
        ...
        {status === 'success' && (
          <>
            ...
            <button
              onClick={() => navigate('/')}
              style={{ background: GREEN, color: '#04060d', border: 'none', borderRadius: 10, padding: '12px 32px', fontSize: 15, fontWeight: 700, cursor: 'pointer', fontFamily: "'Inter', sans-serif" }}
            >
              Go to Dashboard
            </button>
          </>
